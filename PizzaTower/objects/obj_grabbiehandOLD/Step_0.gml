...
if (distance_to_pos(x, y, xstart, ystart, 6, 6) && obj_player.sprite_index != spr_player_catched && obj_player.x > (x - 50) && obj_player.x < (x + 50) && obj_player.y > y && obj_player.y < (y + 200) && !thumbingup)
{
    delay--;
    if (delay <= 0)
    {
