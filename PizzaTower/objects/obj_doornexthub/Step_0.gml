...
if (sprite_index == spr_elevatoropening && ANIMATION_END && place_meeting(x, y, obj_player1) && !instance_exists(obj_jumpscare) && floor(obj_player1.image_index) == (obj_player1.image_number - 1) && obj_player1.state == states.victory)
{
	with (obj_player1)
	{
