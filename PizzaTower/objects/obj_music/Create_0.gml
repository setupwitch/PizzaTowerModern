...
add_music(Longintro, "event:/music/intro", noone, false, function(_room, _event_instance)
{
	fmod_event_instance_set_parameter(_event_instance, "state", 0, true);
});
add_music(Mainmenu, "event:/music/title", noone, false, function(_room, _event_instance)
{
	fmod_event_instance_set_parameter(_event_instance, "state", 0, true);
});
...
add_music(trickytreat_1, "event:/music/halloween2023", noone, false, function(_room, _event_instance)
{
	...
	{
		fmod_event_instance_set_parameter(_event_instance, "state", 1, true);
	}
});
...
add_music(boss_pizzaface, "event:/music/boss/pizzaface", noone, false, function(_room, _event_instance)
{
	...
	{
		fmod_event_instance_set_parameter(_event_instance, "state", 5, false);
	}
});
add_music(entrance_1, "event:/music/w1/entrance", "event:/music/w1/entrancesecret", false, function(_room, _event_instance, _unknown)
{
	var s = 0;
	fmod_event_instance_set_parameter(_event_instance, "state", s, true);
});
add_music(medieval_1, "event:/music/w1/medieval", "event:/music/w1/medievalsecret", false, function(_room, _event_instance, _unknown)
{
	var s = -1;
	switch (_room)
	{
...
add_music(ruin_1, "event:/music/w1/ruin", "event:/music/w1/ruinsecret", false, function(_room, _event_instance)
{
	var s = -1;
	switch (_room)
	{
...
add_music(badland_1, "event:/music/w2/desert", "event:/music/w2/desertsecret", false, function(_room, _event_instance)
{
	var s = -1;
	switch (_room)
	{
...
add_music(farm_2, "event:/music/w2/farm", "event:/music/w2/farmsecret", false, function(_room, _event_instance)
{
	var s = -1;
	switch (_room)
	{
...
add_music(forest_1, "event:/music/w3/forest", "event:/music/w3/forestsecret", false, function(_room, _event_instance)
{
	var s = -1;
	switch (_room)
	{
...
add_music(freezer_1, "event:/music/w4/freezer", "event:/music/w4/freezersecret", false, function(_room, _event_instance, _unknown)
{
	var s = -1;
	switch (_room)
	{
...
add_music(industrial_1, "event:/music/w4/industrial", "event:/music/w4/industrialsecret", false, function(_room, _event_instance, _unknown)
{
	var s = -1;
	switch (_room)
	{
...
add_music(street_1, "event:/music/w4/street", "event:/music/w4/streetsecret", false, function(_room, _event_instance)
{
	if (_room == street_1 || _room == street_house3)
	{
		fmod_event_instance_set_parameter(_event_instance, "state", 0, true);
	}
	else if (_room == street_bacon)
	{
		fmod_event_instance_set_parameter(_event_instance, "state", 2, true);
	}
	if (_room == street_jail)
	{
