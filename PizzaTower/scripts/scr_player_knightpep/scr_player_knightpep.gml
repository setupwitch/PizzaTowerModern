function scr_player_knightpep()
{
	...
	if ((ANIMATION_END && sprite_index == spr_knightpepjump) || (!grounded && sprite_index != spr_knightpepjumpstart && sprite_index != spr_knightpepjump && sprite_index != spr_knightpepthunder && sprite_index != spr_knightpepdowntrust && sprite_index != spr_knightpepdoublejump && sprite_index != spr_playerN_knightdoublejumpfall))
	{
	...
	if (ANIMATION_END && sprite_index == spr_knightpepdoublejump)
	{
		image_index = image_number - 1;
	}
	if (ANIMATION_END && sprite_index == spr_playerN_knightdoublejumpfall)
	{
		image_index = image_number - 1;
	}
